...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dashboard$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/dashboard.js [app-rsc] (ecmascript)");
...
async function DashboardPage({ searchParams }) {
    ...
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dashboard$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDashboardData"])(payload.salonId, range);
...
"[project]/lib/dashboard.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {

const mongoose = __turbopack_context__.r("[externals]/mongoose [external] (mongoose, cjs, [project]/node_modules/mongoose)");
const Transaction = __turbopack_context__.r("[project]/models/Transaction.js [app-rsc] (ecmascript)");
const { resolveDateRange } = __turbopack_context__.r("[project]/lib/dates/timezone.js [app-rsc] (ecmascript)");
/**
 ...
 */ async function getDashboardData(salonId, range) {
    ...
    const [summaryResult, dailySales, topServices, payments, recentTransactions] = await Promise.all([
        ...
        Transaction.find(baseFilter).sort({
            createdAt: -1
        }).limit(8).lean()
    ]);
    // Format summary
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1lzd3tr._.js.map