...
"[project]/components/transactions/TransactionsManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TransactionsManager = ({ initialTransactions, initialTotal })=>{
    ...
    const [filterPaymentMethod, setFilterPaymentMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const addToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsManager.useCallback[addToast]": (type, message)=>{
            const id = ++toastId;
            setToasts({
                "TransactionsManager.useCallback[addToast]": (prev)=>[
                        ...prev.slice(-2),
                        {
                            id,
                            type,
            ...
            }["TransactionsManager.useCallback[addToast]"]);
        }
    }["TransactionsManager.useCallback[addToast]"], []);
    const removeToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsManager.useCallback[removeToast]": (id)=>{
            setToasts({
                "TransactionsManager.useCallback[removeToast]": (prev)=>prev.filter({
                        "TransactionsManager.useCallback[removeToast]": (t)=>t.id !== id
                    }["TransactionsManager.useCallback[removeToast]"])
            }["TransactionsManager.useCallback[removeToast]"]);
        }
    }["TransactionsManager.useCallback[removeToast]"], []);
    const fetchTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsManager.useCallback[fetchTransactions]": async ()=>{
            try {
                setLoading(true);
                setError("");
    ...
    }["TransactionsManager.useCallback[fetchTransactions]"], [
        page,
        limit,
        search,
        filterPaymentMethod
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionsManager.useEffect": ()=>{
            const handleVisibilityChange = {
                "TransactionsManager.useEffect.handleVisibilityChange": ()=>{
            ...
            return ({
                "TransactionsManager.useEffect": ()=>document.removeEventListener("visibilitychange", handleVisibilityChange)
            })["TransactionsManager.useEffect"];
        }
    }["TransactionsManager.useEffect"], [
        fetchTransactions
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: transactions.map((txn)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: `inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border shrink-0 ${getStatusStyle(txn.paymentStatus)}`,
...
_s(TransactionsManager, "BvmIqO/qoXuB+IUCgO270Qal48U=");
_c = TransactionsManager;
const __TURBOPACK__default__export__ = TransactionsManager;
var _c;
__turbopack_context__.k.register(_c, "TransactionsManager");
...
//# sourceMappingURL=components_04oy_cs._.js.map