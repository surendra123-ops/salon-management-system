...
"[project]/app/(dashboard)/transactions/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TransactionsPage = ()=>{
    ...
    const addToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsPage.useCallback[addToast]": (type, message)=>{
            const id = ++toastId;
            setToasts({
                "TransactionsPage.useCallback[addToast]": (prev)=>[
                        ...prev.slice(-2),
                        {
                            id,
                            type,
            ...
            }["TransactionsPage.useCallback[addToast]"]);
        }
    }["TransactionsPage.useCallback[addToast]"], []);
    const removeToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsPage.useCallback[removeToast]": (id)=>{
            setToasts({
                "TransactionsPage.useCallback[removeToast]": (prev)=>prev.filter({
                        "TransactionsPage.useCallback[removeToast]": (t)=>t.id !== id
                    }["TransactionsPage.useCallback[removeToast]"])
            }["TransactionsPage.useCallback[removeToast]"]);
        }
    }["TransactionsPage.useCallback[removeToast]"], []);
    const fetchTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsPage.useCallback[fetchTransactions]": async ()=>{
            try {
                setLoading(true);
                setError("");
    ...
    }["TransactionsPage.useCallback[fetchTransactions]"], [
        page,
        limit,
        search,
        filterPaymentMethod
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionsPage.useEffect": ()=>{
            const handleVisibilityChange = {
                "TransactionsPage.useEffect.handleVisibilityChange": ()=>{
            ...
            return ({
                "TransactionsPage.useEffect": ()=>document.removeEventListener("visibilitychange", handleVisibilityChange)
            })["TransactionsPage.useEffect"];
        }
    }["TransactionsPage.useEffect"], [
        fetchTransactions
...
_s(TransactionsPage, "rFfq4R3WniASL1E5XZN3hdWgD7E=");
_c = TransactionsPage;
...
//# sourceMappingURL=_0yz_8wr._.js.map